...
def render_home(model: SiteModel) -> str:
    ...
    body = "".join(
        [
            ...
            linked("players/index.html#career-leaderboard", "Career Leaderboard") + table(["Player", "Points", "Submissions", "Average Points", "Round Wins"], leaderboard_rows) + "</section>",
            linked("players/index.html#trending-last-5-rounds", "Trending (Last 5 Rounds)") + "<p>Based on the most recent 5 rounds across all leagues.</p>" + table(["Player", "Submissions", "Points", "Average Points", "Wins"], trending_rows) + "</section>",
