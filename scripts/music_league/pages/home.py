...
def render_home(model: SiteModel) -> str:
    ...
    body = "".join(
        [
            ...
            linked("players/index.html", "Trending (Last 5 Rounds)") + "<p>Based on the most recent 5 rounds across all leagues.</p>" + table(["Player", "Submissions", "Points", "Average Points", "Wins"], trending_rows) + "</section>",
